...
<head>
  ...
  <link rel="stylesheet" href="css/main.css?v=<?php echo md5_file("css/main.css")?>">
  <script src="./js/jquery.min.js"></script>
  <script src="./js/main.js?v=<?php echo md5_file("./js/main.js")?>"></script>
  <script src="./js/reviews.js?v=<?php echo md5_file("./js/reviews.js")?>"></script>
  <script src="./js/color-picker.js?v=<?php echo md5_file("./js/color-picker.js")?>"></script>
</head>
